...
Definition \ref{def:conditional-probability} can be easily manipulated to obtain another basic result, called the \textit{chain rule of conditional probabilities}:
